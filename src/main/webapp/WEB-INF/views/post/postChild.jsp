		...
		<div class="row row-offcanvas row-offcanvas-right">
			<div class="col-xs-12 col-sm-9">
				...
				<div class="col-xs-12 col-sm-12">
					<form class="form-horizontal" role="form" action="/post/child" method="post" id="frm" enctype="multipart/form-data">
						<input type="hidden" name="id" value="${id }">
						<input type="hidden" name="pt_no" value="${pt_no }">
						<input type="hidden" name="bd_no" value="${bd_no }">
						<input type="hidden" name="pt_group" value="${pt_group }">

						<div class="form-group">
							<label for="pic" class="col-sm-1 control-label"
								style="text-align: left;">제목</label>
							<div class="col-sm-10">
								<input type="text" name="title" value="${postVo.pt_title }" style="width:100%">
							</div>
						</div>
						...
						<label for="name" class="col-sm-2 control-label"
							style="text-align: left;">첨부파일</label>
						<div class="col-sm-10">
